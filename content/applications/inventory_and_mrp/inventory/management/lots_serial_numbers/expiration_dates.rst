...
.. note::
   To manufacture a product, there must be materials to consume in the :guilabel:`Product` lines.
   This can be achieved either by creating a :guilabel:`Bill of Material` for the
   :guilabel:`Product`, or manually adding materials to consume by clicking :guilabel:`Add a line`.
...
:guilabel:`Group By`, click :guilabel:`Add Custom Group`, and click the drop-down to select
:guilabel:`Expiration Date.` Finally, click :guilabel:`Apply` to apply the filter.
